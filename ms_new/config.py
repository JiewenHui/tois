...
flags.DEFINE_string("filter_sizes", '10,20,30,40', "Comma-separated filter sizes (default: '3,4,5')")
flags.DEFINE_integer("num_filters", 40, "Number of filters per filter size (default: 128)")
...
flags.DEFINE_integer("max_len_right", 100, "max document length of right input")
